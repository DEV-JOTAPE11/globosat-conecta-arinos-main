        ...
        <div className="grid lg:grid-cols-2 gap-12 mb-12">
          ...
          <div className="space-y-6 animate-fade-up" style={{ animationDelay: "0.2s" }}>
            ...
            <div className="rounded-xl overflow-hidden shadow-medium h-64">
              <iframe
                src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3856.386664977466!2d-46.105556!3d-15.916111!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x0%3A0x0!2zMTXCsDU0JzU4LjAiUyA0NsKwMDYnMjAuMCJX!5e0!3m2!1spt-BR!2sbr!4v1620000000000!5m2!1spt-BR!2sbr" // Substitua por um link válido do Google Maps Embed se este não funcionar
                width="100%"
                height="100%"
                style={{ border: 0 }}
                allowFullScreen={true} // Use camelCase e {true} ou apenas allowFullScreen
                loading="lazy"
                referrerPolicy="no-referrer-when-downgrade" // Use camelCase aqui
